...
import com.deco2800.game.components.tasks.PlayerCheckVertical;
...
public class PlayerFactory {
  ...
  public static Entity createPlayer() {
    ...
    AITaskComponent aiComponent =
            new AITaskComponent()
                    .addTask(new PlayerCheckVertical());
    ...
    Entity player =
        new Entity()
            ...
            .addComponent(new PlayerMovementComponent(PhysicsLayer.OBSTACLE)); // Added in to allow                                          // for collision controlled jumping
