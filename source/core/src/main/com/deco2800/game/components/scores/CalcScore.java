...
public class CalcScore {
    ...
    public int calculateScore(int clock) {
        ...
        int levelScore = 100; // The player will be awarded of 100 points/second remaining
        int secondsLeftOver = levelMaxTime - clock;

        // You can't ever get a score of 0.
        // (Since 0 score turns into a '-' when read from textfile)
